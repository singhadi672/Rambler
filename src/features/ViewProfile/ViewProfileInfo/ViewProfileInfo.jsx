  ...
  return viewProfileAccount ? (
    <div className="view-profile-info">
      <div className="basic-info">
        <img src={viewProfileAccount.user.profilePicture} alt="view-profile" />
      ...
      <div className="view-profile-details">
        <button
          ...
          style={{
            borderBottom:
              viewProfileTab === "followers" && "2px solid var(--border-light)",
          }}
        >
          Followers
        </button>
        <button
          ...
          style={{
            borderBottom:
              viewProfileTab === "following" && "2px solid var(--border-light)",
          }}
        >
          Following
        </button>
